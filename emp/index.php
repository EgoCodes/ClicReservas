<?php
    ...
    if(isset($_SESSION['empresa'])){
        header('Location: ../emp/perfil-empresa.php');
    }
...
<body>
    <div class="informacion">
        ...
        <div class="row">
            <div class="col-12">
                <p class="mensaje">Hola, que bueno que hayas vuelto. inicia sesión y administrar tu negocio</p>
                ...
                <form  method="post" class="formulariol">
                    <div class="form-row">
                        ...
                        <div class="col-12 gr">
                            <button class="btn-olvide" type="button" data-toggle="modal" data-target="#ayuda" style="color:#454545;">Necesito
                                ayuda para iniciar sesión</button>
                        </div>

                        <div class="col-6 gr">
                            <a class="btn-reg" href="registro" style="color:#454545;">Registrarme</a>
                        </div>

                        <div class="col-6 gr log">
                            <input class="btn-general" id="boton_L" type="submit" value="Entrar" style="background-color:#454545;">
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <form method="POST" class="olvidadiso">
                        <div class="form-row">
                            ...
                            <div class="col-12 gr log">
                                <hr>
                                <input class="btn-general" type="submit" value="Enviar" style="background-color:#454545;">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script src="../recursos/js/sesionEmp.js"></script>
</body>
</html>