...
<body>
    <div class="informacionR">
        <div class="row">
            <div class="col-12">
                <h1 class="titulo">
                    <a href="../emp" class="logo">CLICEMPRESAS</a>
                </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                    <p class="mensaje">Registrate y has que tu negocio tenga mucho más alcance.</p>
                ...
                <form method="POST" class="formularior">
                    ...
                    <div class="form-group ini">
                        <a class="btn-olvide" href="../emp">Ya tengo una cuenta</a>
                    </div>
                    <div class="form-group gr">
